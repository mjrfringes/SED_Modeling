...
T_list=[4500.]
m_sun_list = [5.]
l_sun_list = [20.,40.,60.,80.,100.]
disk_mass_list = [0.003]
disk_rmax_list = [100.]
disk_rmin_list = [1.,2.,5.,10.]
disk_h0_list = [0.1]
...
if os.path.exists(filename):
	...
	for mylist in list_of_lists_flattened:	
		add = 'yes'
		for n in range(L):
			if mylist[1:] == [grid[n][col] for col in ['folder','L_sun','M_sun','env_mass','env_type','disk_rmax','env_rmin','rc','env_power','disk_h0','disk_mass',\
