		...
		for env_mass in env_mass_list:
			for rc in rc_list:
				for dustfile in dustfilelist:
					...
					IRS48 = m.YSOModelSim(name=name,folder=folder,L_sun=l_sun,M_sun=m_sun,env_mass=env_mass,env_type=envtype,disk_rmax=disk_rmax,\
					...
					IRS48.plotModel(extinction=ext,show=True,inc=inc,sourcename='Oph.1') 	
					#time.sleep(2)
					#m.modelDump(WL16)
